# Disturbance prediction (field data)
...
# Convert to jpeg
bitmap <- pdf_render_page("Figures/grubbing_model_drc.pdf", page = 1, dpi = 300)
jpeg::writeJPEG(bitmap, "Figures/grubbing_model_drc.jpeg")
